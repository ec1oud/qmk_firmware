...
[BASE] = KEYMAP(  // layer 0 : default
        // left hand
        KC_FN2,         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_6,
        ...
        // right hand
             KC_GRV,     KC_7,   KC_8,   KC_9,   KC_0,   KC_EQL,         KC_BSLS,
...
const uint16_t PROGMEM fn_actions[] = {
    [1] = ACTION_LAYER_TAP_TOGGLE(FNMM),               // FN1 - Toggle Layer 1
    [2] = ACTION_LAYER_MOMENTARY(FNMM)                 // FN2 - Momentary Layer 1
};
